...
const Section: React.FC<SectionProps> = ({
  ...
  return (
    <motion.div
      ref={sectionRef}
      className={`flex flex-col lg:flex-row gap-6 sm:gap-8 items-center mb-16 sm:mb-24 md:mb-32 ${index === 0 ? "mt-8 sm:mt-12" : ""}`}
    ...
    >
        ...
        >
          ...
          <div className="relative">
            <img
              ...
              alt={title}
              className="relative w-full object-cover rounded-xl max-w-[300px] sm:max-w-[400px] md:max-w-[450px] lg:max-w-[500px] shadow-lg hover:shadow-xl transition-shadow duration-300"
            />
            <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 p-2 sm:p-3 bg-white rounded-full shadow-lg">{medicalIcon}</div>
          </div>
        </motion.div>
      </motion.div>
      ...
      >
        <motion.div className="mb-4 sm:mb-6" variants={itemVariants}>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2 sm:mb-3 flex items-center gap-2 sm:gap-3 break-words">
            {title}
            <span className="text-blue-500">{medicalIcon}</span>
          </h2>
          <motion.div
            className="h-1 w-16 sm:w-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"
            initial={{ width: 0 }}
            whileInView={{ width: status === "right" ? 80 : 64 }}
            viewport={{ once: true }}
        ...
        <div className="space-y-3 sm:space-y-4">
          <motion.p className="text-gray-600 leading-relaxed text-sm sm:text-base md:text-lg break-words" variants={itemVariants}>
            {content1}
          </motion.p>
        ...
        {/* Feature Points */}
        <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 mt-6 sm:mt-8" variants={containerVariants}>
          <motion.div
            className="flex items-start gap-2 sm:gap-3 hover:bg-blue-50 p-2 sm:p-3 rounded-lg transition-all duration-300 shadow-sm hover:shadow-md"
            variants={itemVariants}
            whileHover="hover"
          >
            <div className="flex-shrink-0">
              <motion.div
                className="p-2 sm:p-3 bg-blue-100 rounded-lg"
                whileHover={{
                  rotate: [0, 10, -10, 10, 0],
                  scale: [1, 1.1, 1, 1.1, 1],
                }}
            ...
            <div>
              <h4 className="font-semibold text-gray-800 text-base sm:text-lg break-words">{icontitle1}</h4>
              <p className="text-xs sm:text-sm text-gray-600 break-words">{iconp1}</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <h4 className="font-semibold text-gray-800 text-base sm:text-lg break-words">{icontitle2}</h4>
              <p className="text-xs sm:text-sm text-gray-600 break-words">{iconp2}</p>
            </div>
          </motion.div>
        </motion.div>
      </motion.div>
...
const InfoSection: React.FC = () => {
  const sections = [
    {
      img: aboutUs,
      icon1: <Stethoscope className="w-5 sm:w-6 h-5 sm:h-6 text-blue-500" />,
      icon2: <Heart className="w-5 sm:w-6 h-5 sm:h-6 text-blue-500" />,
      title: "About Us",
      content1:
      ...
      status: "left",
      medicalIcon: <Stethoscope className="w-5 sm:w-6 h-5 sm:h-6" />,
    },
    {
      img: mission,
      icon1: <Shield className="w-5 sm:w-6 h-5 sm:h-6 text-blue-500" />,
      icon2: <Activity className="w-5 sm:w-6 h-5 sm:h-6 text-blue-500" />,
      title: "Our Mission",
      content1:
      ...
      status: "right",
      medicalIcon: <Heart className="w-5 sm:w-6 h-5 sm:h-6" />,
    },
    {
      img: challenges,
      icon1: <Brain className="w-5 sm:w-6 h-5 sm:h-6 text-blue-500" />,
      icon2: <Globe className="w-5 sm:w-6 h-5 sm:h-6 text-blue-500" />,
      ...
      status: "left",
      medicalIcon: <Activity className="w-5 sm:w-6 h-5 sm:h-6" />,
    },
  ]
  ...
  return (
    <div className="scroll-smooth w-full max-w-[1538px] mx-auto relative py-12 sm:py-16">
      {/* Background elements */}
      <motion.div
        className="absolute top-0 right-0 w-64 sm:w-96 h-64 sm:h-96 bg-blue-500/5 rounded-full mix-blend-multiply filter blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          x: [0, -30, 0],
          y: [0, 30, 0],
      ...
      <motion.div
        className="absolute bottom-0 left-0 w-64 sm:w-96 h-64 sm:h-96 bg-purple-500/5 rounded-full mix-blend-multiply filter blur-3xl"
        animate={{
          scale: [1, 1.3, 1],
          x: [0, 30, 0],
          y: [0, -30, 0],
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20 flex flex-col gap-y-16 sm:gap-y-24 md:gap-y-32 relative z-10">
